...
void MainWindow::statistiquesEmploye()
{
    ...
    QString a = QString("  &lt; 1000 ") + QString::number((exp1 * 100) / total, 'f', 2) + "%";
    QString b = QString(">1000 &  &lt; 1500 ") + QString::number((exp2 * 100) / total, 'f', 2) + "%";
    QString c = QString(">1500 &  &lt; 2000 ") + QString::number((exp3 * 100) / total, 'f', 2) + "%";
    QString d = QString(">2000 ") + QString::number((exp4 * 100) / total, 'f', 2) + "%";
...
void MainWindow::on_pushButton_92_clicked()  // Exportation PDF :
{
    ...
    out << "<html>\n"
          ...
          // "<title>ERP - COMmANDE LIST</title>\n "
           ...
           "<img src=\"C:/Users/MSI/OneDrive - ESPRIT/Bureau/Nouveau dossier/projet/logo_new\" class=\"logo\">" // Update the path and class

          // "<p  >           <img src=\"C:/Users/MSI/OneDrive - ESPRIT/Bureau/Nouveau dossier/projet/logo\" class=\"logo\"></p>" // Update the path and class

          //  "<p >Faire la kamelia avant l'image                 &emsp;         image  oo  <img src=\"C:/Users/MSI/OneDrive - ESPRIT/Bureau/Nouveau dossier/projet/logo\" class=\"logo\"></p>"
