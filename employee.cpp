...
Employee::Employee(QString a,QString b,QString c,QString d,int e,QString f,int g, QString ref)
{
    nom=a;
    prenom=b;
    email=c;
...
void Employee::setRFIDTag(QString ref){RFIDTag=ref;}
QString Employee::get_RFIDTag(){return RFIDTag;}

bool Employee::ajouter(QString pos)
{
       QSqlQuery query;

             query.prepare("INSERT INTO EMPLOYES (nom, prenom,email, date_embauche,salaire,poste,cin,mot_de_passe, rfidtag) "
                        "VALUES (:nom, :prenom,:email, :date_embauche,:salaire,:poste,:cin,:mot_de_passe, :RFIDTag)");
...
bool Employee::update(int id)
{
    ...
    query.prepare("UPDATE EMPLOYES SET nom=:nom, prenom=:prenom, email=:email,date_embauche=:date_embauche, salaire=:salaire, poste=:poste,cin=:cin_new,mot_de_passe=:mot_de_passe, RFIDTag=:RFIDTag  WHERE cin=:cin_old");
